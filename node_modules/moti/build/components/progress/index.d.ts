...
export declare function MotiProgressBar({ height, progress, borderRadius, style, colorMode, containerColor, containerStyle, color, transition, silenceRenderWarnings, }: MotiProgressBarProps): import("react/jsx-runtime").JSX.Element;
