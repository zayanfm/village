...
export function Hoverable({ onHoverIn, onHoverOut, children, childRef, }) {
    ...
    useEffect(function disableHoverOnClickOutside() {
    ...
    return (_jsx(HoveredContext.Provider, { value: isHovered, children: React.cloneElement(child, {
